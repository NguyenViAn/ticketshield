...
VALUES 
('V-League 2024/25', 'https://upload.wikimedia.org/wikipedia/vi/thumb/9/9c/V.League_1_logo.svg/1200px-V.League_1_logo.svg.png'),
('La Liga', 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0f/LaLiga_logo_2023.svg/1024px-LaLiga_logo_2023.svg.png'),
('Serie A', 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/96/Lega_Serie_A_logo_%282021%29.svg/1200px-Lega_Serie_A_logo_%282021%29.svg.png');
...
(
    ...
    'https://upload.wikimedia.org/wikipedia/vi/thumb/6/6b/Cong_an_Ha_Noi_FC.svg/1200px-Cong_an_Ha_Noi_FC.svg.png',
    NOW() + INTERVAL '4 days',
...
(
    ...
    'https://upload.wikimedia.org/wikipedia/vi/thumb/1/12/Nam_Dinh_FC_logo_2021.svg/1200px-Nam_Dinh_FC_logo_2021.svg.png',
    NOW() + INTERVAL '5 days',
    'Sân vận động Pleiku',
    300000,
    'Standard'
...
(
    ...
    'https://upload.wikimedia.org/wikipedia/vi/thumb/c/c1/Atletico_Madrid_logo.svg/1200px-Atletico_Madrid_logo.svg.png',
